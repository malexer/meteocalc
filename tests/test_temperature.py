...
class TempTest(unittest.TestCase):
    ...
    def test_mul_with_float(self):
        t = temperature.Temp(100, units='C')
        t2 = t * 2
    ...
    def test_truediv_with_float(self):
        t = temperature.Temp(573, units='K')
        t2 = t / 2
